//This is where the code goes that reaches out to the server to send information back and forth.
//Info can travel back and forth using fetch

document.getElementById('getButton').addEventListener('click', apiRequest) // For button
